...
- 原始文件: `D:\code2026\docx-template-agent\outputs\web\79b9d490c06d41b78714305b7f1fb7f5\demo_source_20260627_151343.docx`
- 使用模板: `report`
- 检查时间: `2026-06-27T15:13:44`
- 段落数: `8`
- 表格数: `1`
- 问题总数: `64`
- 操作总数: `10`
...
| issue-0035 | first_line_indent_chars | paragraph#5 | body | - | 2 | paragraph 5 first_line_indent_chars mismatch: current=None, expected=2 |
| issue-0036 | font_name | paragraph#6 | body | 微软雅黑 | SimSun | paragraph 6 font_name mismatch: current='微软雅黑', expected='SimSun' |
| issue-0037 | font_size | paragraph#6 | body | 10.5 | 12 | paragraph 6 font_size mismatch: current=10.5, expected=12 |
| issue-0038 | bold | paragraph#6 | body | - | False | paragraph 6 bold mismatch: current=None, expected=False |
| issue-0039 | alignment | paragraph#6 | body | - | justify | paragraph 6 alignment mismatch: current=None, expected='justify' |
| issue-0040 | line_spacing | paragraph#6 | body | - | 1.5 | paragraph 6 line_spacing mismatch: current=None, expected=1.5 |
| issue-0041 | space_before | paragraph#6 | body | - | 0 | paragraph 6 space_before mismatch: current=None, expected=0 |
| issue-0042 | space_after | paragraph#6 | body | - | 0 | paragraph 6 space_after mismatch: current=None, expected=0 |
| issue-0043 | first_line_indent_chars | paragraph#6 | body | - | 2 | paragraph 6 first_line_indent_chars mismatch: current=None, expected=2 |
| issue-0044 | font_name | paragraph#7 | body | 微软雅黑 | SimSun | paragraph 7 font_name mismatch: current='微软雅黑', expected='SimSun' |
| issue-0045 | font_size | paragraph#7 | body | 10.5 | 12 | paragraph 7 font_size mismatch: current=10.5, expected=12 |
| issue-0046 | bold | paragraph#7 | body | - | False | paragraph 7 bold mismatch: current=None, expected=False |
| issue-0047 | alignment | paragraph#7 | body | - | justify | paragraph 7 alignment mismatch: current=None, expected='justify' |
| issue-0048 | line_spacing | paragraph#7 | body | - | 1.5 | paragraph 7 line_spacing mismatch: current=None, expected=1.5 |
| issue-0049 | space_before | paragraph#7 | body | - | 0 | paragraph 7 space_before mismatch: current=None, expected=0 |
| issue-0050 | space_after | paragraph#7 | body | - | 0 | paragraph 7 space_after mismatch: current=None, expected=0 |
| issue-0051 | first_line_indent_chars | paragraph#7 | body | - | 2 | paragraph 7 first_line_indent_chars mismatch: current=None, expected=2 |
| issue-0052 | font_name | paragraph#8 | body | 微软雅黑 | SimSun | paragraph 8 font_name mismatch: current='微软雅黑', expected='SimSun' |
| issue-0053 | font_size | paragraph#8 | body | 10.5 | 12 | paragraph 8 font_size mismatch: current=10.5, expected=12 |
| issue-0054 | bold | paragraph#8 | body | - | False | paragraph 8 bold mismatch: current=None, expected=False |
| issue-0055 | alignment | paragraph#8 | body | - | justify | paragraph 8 alignment mismatch: current=None, expected='justify' |
| issue-0056 | line_spacing | paragraph#8 | body | - | 1.5 | paragraph 8 line_spacing mismatch: current=None, expected=1.5 |
| issue-0057 | space_before | paragraph#8 | body | - | 0 | paragraph 8 space_before mismatch: current=None, expected=0 |
| issue-0058 | space_after | paragraph#8 | body | - | 0 | paragraph 8 space_after mismatch: current=None, expected=0 |
| issue-0059 | first_line_indent_chars | paragraph#8 | body | - | 2 | paragraph 8 first_line_indent_chars mismatch: current=None, expected=2 |
| issue-0060 | font_name | table#1 | table | 宋体 | SimSun | table 1 font_name mismatch: current='宋体', expected='SimSun' |
| issue-0061 | bold | table#1 | table | [True, False] | False | table 1 bold mismatch: current=[True, False], expected=False |
| issue-0062 | alignment | table#1 | table | - | center | table 1 alignment mismatch: current=None, expected='center' |
| issue-0063 | font_name | table_header#1 | table_header | 宋体 | SimHei | table_header 1 font_name mismatch: current='宋体', expected='SimHei' |
| issue-0064 | alignment | table_header#1 | table_header | - | center | table_header 1 alignment mismatch: current=None, expected='center' |
